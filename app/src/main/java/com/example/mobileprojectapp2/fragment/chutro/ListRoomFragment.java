...
import com.example.mobileprojectapp2.activity.chutro.roommessage.RoomMassageActivity;
import com.example.mobileprojectapp2.adpater.chutro.PhongTinNhanAdapter;
...
public class ListRoomFragment extends AbstractFragment{
    ...
    PhongTinNhanAdapter phongTinNhanAdapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentLayout = null;
        fragmentLayout = inflater.inflate(R.layout.chutro_fragment_list_message_layout, container, false);
    ...
    private void setDuLieu(){
        ...
        phongTinNhanAdapter = new PhongTinNhanAdapter(getActivity(),R.layout.cardview_item_message,arrayList);
        phongTinNhanAdapter.setOnClickItemListener(new PhongTinNhanAdapter.OnClickItemListener() {
            @Override
        ...
        recyclerView.setAdapter(phongTinNhanAdapter);
