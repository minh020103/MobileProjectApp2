...
public class RoomRandomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nguoithue_room_random_layout);
    ...
    private void doDuLieuPhong() {
        listPhong.clear();
        ApiServiceMinh.apiService.randomRoom().enqueue(new Callback<List<PhongTro>>() {
            @Override
        ...
        imgSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (edtComment.length() > 0 && edtComment.length() <= 255) {
                    ...
                    Toast.makeText(RoomRandomActivity.this, "Bình luận tối đa 255 ký tự và phải nhập dữ liệu", Toast.LENGTH_SHORT).show();
                }
            }
        });
