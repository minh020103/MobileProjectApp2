...
public class RoomOfDistrictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nguoithue_room_of_district_layout);
        Intent intent = getIntent();
        idQuan = intent.getIntExtra("idQuan", -1);
    ...
    private void doDuLieuPhong() {
        listPhong.clear();
        ApiServiceMinh.apiService.layTatCaPhongTrongQuan(idQuan, Const.NHO_DEN_LON).enqueue(new Callback<List<PhongTro>>() {
            @Override
        ...
        imgSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (edtComment.length() > 0 && edtComment.length() <= 255) {
                    ...
                    Toast.makeText(RoomOfDistrictActivity.this, "Bình luận tối đa 255 ký tự và phải nhập dữ liệu", Toast.LENGTH_SHORT).show();
                }
            }
        });
