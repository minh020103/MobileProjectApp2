package com.example.mobileprojectapp2.adpater.chutro;
...
public class PhongTinNhanAdapter extends RecyclerView.Adapter<PhongTinNhanAdapter.MyViewHolder> {
    ...
    public PhongTinNhanAdapter(Activity activity, int layoutId, ArrayList<PhongTinNhan> arrayList) {
